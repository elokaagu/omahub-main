          ...
          {dynamicNavigationItems.map((category) => {
            ...
            return (
              <div key={category.title} className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-[500px] bg-gradient-to-br from-white/70 to-oma-beige/60 backdrop-blur-lg rounded-2xl shadow-2xl border border-oma-gold/40 ring-1 ring-oma-plum/10 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="p-4">
                    <div className="mb-4">
