    ...
    <div className={cn("w-full overflow-hidden", className)}>
      ...
      >
        <div
          ...
          className="flex gap-2 sm:gap-3 overflow-x-auto scrollbar-hide snap-x snap-mandatory scroll-smooth pb-4 brand-row-scroll max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
        >
