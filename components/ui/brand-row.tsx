  ...
  return (
    <div className="relative py-6 sm:py-8">
      ...
      <div className="group relative -mx-4 sm:-mx-6 lg:-mx-8">
        <div
          ref={rowRef}
          className="flex space-x-3 sm:space-x-6 overflow-x-scroll scrollbar-hide snap-x snap-mandatory transition-transform duration-500 ease-out pl-4 sm:pl-6 lg:pl-8"
        >
          {brands.map((brand) => (
            <div
              key={brand.id}
