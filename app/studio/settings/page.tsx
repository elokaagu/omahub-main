        ...
        <Card className="border-oma-beige">
          ...
          <CardContent>
            <p className="text-sm text-oma-cocoa/80 mb-4">
              Create and manage your legal documents including Terms of Service
              and Privacy Policy. These documents are displayed on your public
              pages and can be versioned for compliance tracking.
            </p>
          ...
          <div className="px-6 pb-6">
            {isSuperAdmin ? (
              ...
              <div className="text-center">
                <p className="text-sm text-oma-cocoa/60 mb-2">
        ...
        <Card className="border-oma-beige">
          ...
          <CardContent>
            <p className="text-sm text-oma-cocoa/80 mb-4">
              ...
              throughout your site. Organize by category and control where they
              display to provide better user support.
            </p>
            <div className="space-y-2 text-xs text-oma-cocoa/70">
              <div className="flex items-center gap-2">
        ...
        <CardContent>
          <div className="space-y-3 text-sm text-oma-cocoa">
            <div className="flex items-start gap-2">
              ...
              <p>
                <strong>Legal Documents:</strong> Keep your Terms of Service and
                Privacy Policy up to date with version control and effective
                date tracking.
              </p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p>
                ...
                for your users with categorized questions and rich text answers.
              </p>
            </div>
            <div className="flex items-start gap-2">
              <Settings className="h-4 w-4 text-amber-600 mt-0.5 flex-shrink-0" />
              <p>
                <strong>Access Control:</strong> These management tools require
                super admin privileges to ensure content security and
                compliance.
              </p>
            </div>
          </div>
