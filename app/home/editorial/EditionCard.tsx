...
export function EditionCard({ edition }: { edition: Edition }) {
  ...
  return (
    <article className="group relative flex min-h-[520px] flex-col justify-end overflow-hidden rounded-2xl bg-gradient-to-b from-[#5E4331] to-oma-plum shadow-sm ring-1 ring-oma-cocoa/10 transition-shadow duration-300 hover:shadow-lg sm:min-h-[560px]">
