    ...
    <section id="join-the-list" className="bg-oma-cream py-14 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 grid gap-6 sm:mt-12 sm:gap-8 md:grid-cols-2">
          <AnimateOnScroll animation="slideInFromRight" delay={0.1} duration={0.7}>
            <div className="flex h-full flex-col rounded-2xl border border-oma-cocoa/20 bg-white p-6 sm:p-8 lg:p-10">
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-oma-cocoa">
                Community
              </p>
          ...
          <AnimateOnScroll animation="slideInFromRight" delay={0.22} duration={0.7}>
            <div className="flex h-full flex-col rounded-2xl bg-oma-plum p-6 text-white sm:p-8 lg:p-10">
