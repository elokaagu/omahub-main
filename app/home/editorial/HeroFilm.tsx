...
/**
 * Full-bleed hero film. Starts muted (autoplay requires it), with a
 * mute/unmute toggle since Vimeo's chromeless background mode hides all
 * native controls.
 */
  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-pressed={!muted}
        className="absolute bottom-6 right-6 z-10 flex h-11 w-11 items-center justify-center rounded-full bg-oma-black/40 text-white backdrop-blur-sm transition-colors hover:bg-oma-black/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-oma-gold"
      >
        {muted ? (
          <svg
