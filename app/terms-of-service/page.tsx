    ...
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-oma max-w-none">
        ...
        <p className="mb-6 text-oma-cocoa">
          By accessing and using Oma Hub, you accept and agree to be bound by
        ...
        <p className="mb-6 text-oma-cocoa">
          ...
          conduct, and follow our community guidelines when using Oma Hub.
        </p>

        <h2 className="heading-sm mb-4">4. Content Ownership</h2>
        <p className="mb-6 text-oma-cocoa">
          Users retain ownership of their content while granting Oma Hub a
