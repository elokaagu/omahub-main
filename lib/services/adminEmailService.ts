...
export const isSuperAdmin = (email: string) => adminEmailService.isSuperAdmin(email);
export const isBrandAdmin = (email: string) => adminEmailService.isBrandAdmin(email);
export const getSuperAdminEmails = () => adminEmailService.getSuperAdminEmails();
export const getBrandAdminEmails = () => adminEmailService.getBrandAdminEmails();
export const getWebhookAdminEmails = () => adminEmailService.getWebhookAdminEmails();
