...
console.log("5. Check that the Google Client ID and Secret are correctly set");
console.log("6. Navigate to Authentication > URL Configuration");
console.log("7. Set the Site URLs and Redirect URLs as listed above");
console.log("8. In Google Cloud Console, ensure ALL redirect URIs are added");
console.log("\n=== END OF CHECKER ===\n");
